...
<div class="container padding">
 ...
 <a href="" onclick="mySwipe2.next()" class="next default"> <i class="icon-left-open iconsize"></i></a>
  ...
  <div class='swipe-wrap'>
   ...
   <div class="postimgright"> <h3>Great features</h3> <p class="medium">We are a creative agency located in <strong>Brooklyn New York.</strong> We’ve won a ton of awards<br>
